...
more = input(f"Are you still a student? If yes, when are you graduating? Otherwise, skip to the next question")
...
live  = input(f"Thanks for your time, Mr.{lastName} .It was a great pleasure meeting you. In case you have any more question, kindly let me know through this email: olelecaleb176@gmail.com.")
